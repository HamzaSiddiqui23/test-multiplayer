...
public class @PlayerInputActions : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Player Actions"",
            ""id"": ""a7231815-e090-442e-942b-02909a33db36"",
            ""actions"": [
                {
                    ""name"": ""Move"",
                    ""type"": ""Value"",
                    ""id"": ""ceb56148-3c98-42a4-ae34-0ec71d80f60a"",
                ...
                },
                {
                    ""name"": ""Look"",
                    ""type"": ""Value"",
                    ""id"": ""af8d03ac-b00f-4287-8d69-d166fd2c571c"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Fire"",
                    ""type"": ""Button"",
                    ""id"": ""329508fe-80c2-4b34-8318-7e3ab93e10f9"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Crouch"",
                    ""type"": ""Button"",
                    ""id"": ""1eb4dcdb-f2ed-4625-b101-c937a07009e5"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Sprint"",
                    ""type"": ""Button"",
                    ""id"": ""97ede38f-51d6-4847-8114-701a61c1473b"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""af09ce9a-d2ae-4292-b3ed-1b40e9aaf03b"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""5c24f4cd-9e47-4366-97d4-d74af5b5e87c"",
                ...
                {
                    ""name"": ""WASD"",
                    ""id"": ""3f59c6a1-76e5-47a6-b8cc-313319c425d0"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""e3308bcb-4acf-4e9c-9b8e-a15f9f70a45d"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""b046bc28-3f0e-431a-8098-196f1a75f647"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""c49beb79-2325-4e72-a86e-b37a3ae88bc1"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""cfa01614-4144-4cd7-9534-f97fc3b0af41"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""d2bd34bf-dd81-4cf8-89da-4e45aa4f1af8"",
                ...
                {
                    ""name"": """",
                    ""id"": ""fe72eb7a-65d0-45a6-9c24-c8795185faa4"",
                    ""path"": ""<Mouse>/delta"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""027a719b-a21d-41a9-8360-945cd0b402bf"",
                ...
                {
                    ""name"": """",
                    ""id"": ""0859258e-b4fa-4126-b8b7-f23375ce4c20"",
                ...
                {
                    ""name"": """",
                    ""id"": ""01de584d-2dff-402f-a238-9cc192b9baf1"",
                    ""path"": ""<Keyboard>/ctrl"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""0dac2452-f6b2-4ab8-a709-4ef7f346d967"",
                ...
                {
                    ""name"": """",
                    ""id"": ""9b157b76-2412-4641-910c-4cc716b515a9"",
                    ""path"": ""<Keyboard>/shift"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""525b0f61-b9c9-445e-83f9-889ca2c6fc7d"",
                ...
                {
                    ""name"": """",
                    ""id"": ""65de1643-d4f5-47d7-bf34-705ed00c282c"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""3985f2d7-8f52-4574-b9fb-c69db503b8c4"",
